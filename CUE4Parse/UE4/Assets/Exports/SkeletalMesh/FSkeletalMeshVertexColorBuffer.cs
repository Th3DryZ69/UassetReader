...
public class FSkeletalMeshVertexColorBuffer
{
	...
	{
		Data = ((!new FStripDataFlags(Ar, FPackageFileVersion.CreateUE4Version(EUnrealEngineObjectUE4Version.STATIC_SKELETAL_MESH_SERIALIZATION_FIX)).IsDataStrippedForServer()) ? Ar.ReadBulkArray<FColor>() : Array.Empty<FColor>());
	}
