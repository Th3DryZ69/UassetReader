...
public class USoundWave : USoundBase
{
	...
	public override void Deserialize(FAssetArchive Ar, long validPos)
	{
		...
		FName obj2;
		if (TryGetValue<bool>(out var obj, "bStreaming"))
		{
			bStreaming = obj;
		}
		else if (TryGetValue<FName>(out obj2, "LoadingBehavior"))
		{
			bStreaming = !obj2.IsNone && obj2.Text != "ESoundWaveLoadingBehavior::ForceInline";
		}
